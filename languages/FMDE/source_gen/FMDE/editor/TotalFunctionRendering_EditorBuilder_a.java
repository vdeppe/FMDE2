...
/*package*/ class TotalFunctionRendering_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TotalFunctionRendering_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createDiagramConnector_6jlyi6_a();
  }

  private EditorCell createDiagramConnector_6jlyi6_a() {
    final ConnectorCell editorCell = new TotalFunctionRendering_EditorBuilder_a.ConnectorCellImpl_6jlyi6_a(getEditorContext(), myNode);
    editorCell.setCellId("DiagramConnector_6jlyi6_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    DefaultDiagramElementActionMap_0.setCellActions(editorCell, myNode, getEditorContext());
    return editorCell;
  }
  public class ConnectorCellImpl_6jlyi6_a extends ConnectorCell {
    ...
    private ConnectorCellImpl_6jlyi6_a(EditorContext editorContext, SNode node) {
